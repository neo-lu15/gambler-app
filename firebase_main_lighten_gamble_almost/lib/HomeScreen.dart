        ...
        content:SizedBox(
          ...
          child: Column(
            ...
            children: [
              TextField(
                keyboardType: TextInputType.number,
                decoration: InputDecoration(hintText: "投入金額 (最多${user_data[2]})"), //(money range)
                controller: money_input,
                // onSubmitted: (value) {
                //   print("value ${value}");
                // },  
  ...
  void initGame()async{
    ...
    await dbref.onValue.listen((event) {
        ...
        //  print(get);
         ...
         game=Game(get["team1"], get["team2"], get["odd1"], get["odd2"], get["people_num1"], get["people_num2"], get["dollar1"], get["dollar2"], get["status"], get["ans"], get["folder"],TTS);
        //  print("game get");
